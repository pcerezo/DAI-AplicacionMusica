...
class MusicoForm(forms.ModelForm):
    class Meta:
        model = Musico
        fields = ['nombre', 'apellidos', 'fecha_nacimiento', 'instrumento_principal', 'grupos']
        labels = {'nombre' : 'Nombre del artista', 'fecha_nacimiento' : 'Fecha de nacimiento', 'instrumento_principal' : 'Instrumento principal'}

class GrupoForm(forms.ModelForm):
    class Meta:
        model = Grupo
        fields = ['nombre', 'fecha_fundacion', 'estilo']
